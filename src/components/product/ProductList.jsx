...
const ProductList = () => {
  ...
  useEffect(() => {
    ...
    setFilteredProducts(products.filter((product) => product.title.toLocaleLowerCase().includes(search.toLocaleLowerCase())));
  }, [search, products]);
  ...
  return (
    <>
      ...
      <div className="product-container">
        <div className="products containe --grid-25 --py2">
          {filteredProducts.length === 0 ? (
            <h3 className="--text-center">This Product does not Exist</h3>
          ) : (
